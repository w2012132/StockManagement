...
namespace StockManagementAPI.Controllers
{
    ...
    public class StocksController : ControllerBase
    {
        ...
        public StocksController(SM_DBContext context, ILogger<StocksController> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public async Task<ActionResult<Stock>> PostStock(Stock stock)
        {
            ...
            await _context.SaveChangesAsync();
            _logger.LogInformation($"Stock added. Id {stock.StockId}");
        ...
        public async Task<IActionResult> DeleteStock(long id)
        {
            ...
            await _context.SaveChangesAsync();
            _logger.LogInformation($"stock deleted. Id {id}");
